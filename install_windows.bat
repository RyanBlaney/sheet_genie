...
move sheet_genie "%USERPROFILE%\bin\sheet_genie"
if %errorlevel% neq 0 (
...
cd ..
rmdir /s /q sheet_genie

echo Executable moved to %USERPROFILE%\bin\sheet_genie. Ensure %USERPROFILE%\bin is in your PATH.
pause
